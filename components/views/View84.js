            ...
            <div className="bill-inner-view">
                <div className="bill-inner-view-childs">
                    ...
                    <div className="billing-mobile-wrapper" style={{
                        ...
                        >
                            <div className="view84_mobile fontInter">
                                <div className="arrow-icons3">
                                    <h3>{data.time}</h3>
                                </div>
                                <div className="header_mob_84">
                                    <Image
                                        src={arrow}
                                        alt="arrow"
                                        height={100}
                                ...
                                <div className="view84-info-wrapper">
                                    <div className="mob_84_amount">
                                        <h3>{data.amount}</h3>
                                        <p>{data.type}</p>
                                    </div>
                                    <div className="mob_84_amount84">
                                        <div className="mob_84_amount84_wrapper">
                                            <span className="font_change_mob_84">{data.currency}</span>{data.amountCda} <span>{data.amountCdaType}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mob_84_details">
                                        <div className="mob_84_details_childs">
                                            <p>Sending</p>
                                        </div>
                                        <div className="mob_84_details_childs">
                                            <p>{data.sending}</p>
                                    ...
                                    <div className="mob_84_details">
                                        ...
                                        <div className="mob_84_details_childs mob_84_details_childs_fixes">
                                            <p className="specific-color-p">{data.withdraw1}</p>
                                            <p className="specific-color-p">{data.withdraw2}</p>
                                        </div>
                                    </div>
                                    <div className="mob_84_details">
                                        <div className="mob_84_details_childs">
