...
const View7 = () => {
  ...
  const pageName = "VIEW 7";

  const [data, setData] = useState({
    amount: "-$ 176.31",
    transacationcategory: "Uncategorized",
    confirmationnumber: "18Y7IVD54ET",
    status: "Accepted",
    from: "Chequing ****9687",
    reciepientinformation: "afn.9995@gmail.com",
    transacationdate: "Aug 3, 2023",
    expirydate: "Sep 2, 2023",
  });
          ...
          <div className="billing-mobile-wrapper" style={{
            ...
            >
              ...
              >
                ...
                <g data-name="Group 8" transform="translate(-1300 -235)">
                  <g data-name="Group 4" transform="translate(898 231)">
                  ...
                  <g data-name="Group 5" transform="translate(-22 -177)">
                    <path
                      fill="#fff"
                      d="M0 0H886V117H0z"
                      data-name="Rectangle 26"
                      transform="translate(1818 4341)"
                    ></path>
                    {
                      isIOS
                        ?
                  ...
                  <g data-name="Group 7">
                    <path
                      ...
                      transform="translate(2751 1156)"
                    ></path>
                    <g data-name="Group 6" transform="translate(450 -18)">
                      <circle
                        cx="80"
                        cy="80"
                        r="80"
          ...
          <div className="bill-inner-view-childs">
            ...
            <div className="global_form_wrapper">
              ...
              <div className="global_form_inner">
                ...
                <input
                  type="text"
                  value={data.transacationcategory}
                  name="transacationcategory"
                  onChange={(e) => onChangeHandler(e)}
                />
              </div>
              <div className="global_form_inner">
              ...
              <div className="global_form_inner">
                ...
                <input
                  type="text"
                  value={data.reciepientinformation}
                  name="reciepientinformation"
                  onChange={(e) => onChangeHandler(e)}
                />
              </div>
              <div className="global_form_inner">
                ...
                <input
                  type="text"
                  value={data.transacationdate}
                  name="transacationdate"
                  onChange={(e) => onChangeHandler(e)}
                />
              </div>
              <div className="global_form_inner">
