...
const View74 = () => {
    ...
    const pageName = "VIEW 74";

    const [data, setData] = useState({
        withdraw: "Withdraw USDC (Ethereum (ERC20))",
        withdrawAlt: "",
        status: "Pending",
        ...
        amountCdaType: "CAD",
        sending: "1,309 USDC",
        withdraw1: "0x7D6635470C9dE85c999273",
        withdraw2: "e6A4a3ab6F64Db4010",
        fee: "10 USDC",
        networkType: "ERC20",
        total: "1,319 USDC",
        type: "USDC",
            ...
            <div className="bill-inner-view">
                <div className="bill-inner-view-childs">
                    ...
                    <div className="billing-mobile-wrapper" style={{
                        ...
                        >
                            <div className="view74_mobile fontInter">
                                ...
                                <div className="view74-info-wrapper">
