                    ...
                    <div className="billing-mobile-wrapper" style={{
                        ...
                        >
                            ...
                            >
                                ...
                                <g id="Group_19" data-name="Group 19" transform="translate(-705 -75)">
                                    <g id="Group_18" data-name="Group 18" transform="translate(141 -20)">
                                        ...
                                        ></path>
                                        <g id="Group_17" data-name="Group 17" transform="translate(458.5)">
                                            <g id="Group_15" data-name="Group 15">
                                                ...
                                                >
                                                    <ellipse
                                                        ...
                                                        rx="23.5"
                                                        ry="22.5"
                                                        transform="translate(414 575.136)"
                                                    ></ellipse>
                                                    <ellipse
                                                        id="Ellipse_113"
                                                        cx="17.5"
                                                        ...
                                                        rx="17.5"
                                                        ry="17"
                                                        transform="translate(419 581.136)"
                                                    ></ellipse>
                                                    <path
                                                        id="bitcoin-2"
                                                        fill="#fd9a00"
                                                        ...
                                                        data-name="bitcoin"
                                                        transform="rotate(3 -10859.286 8307.296)"
                                                    ></path>
                                                </g>
                                                <g
                                                    id="Rectangle_5"
                                            ...
                                            <g id="Group_11" data-name="Group 11">
                                                ...
                                                <g id="Group_10" fill="#fff" data-name="Group 10">
                                                    ...
                                                    <path
                                                        id="Rectangle_10"
                                                        d="M0 0a4 4 0 0 1 4 4v3a4 4 0 0 1-4 4z"
                                                        data-name="Rectangle 10"
                                                        transform="translate(157 459)"
                                                    ></path>
                                                    <rect
                                                        id="Rectangle_11"
                                                        width="9"
