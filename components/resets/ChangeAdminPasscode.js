...
import { resetAdminPasscode } from '@/app/action/user/action';
...
const ChangeAdminPassword = () => {
    ...
    const handleForm = async (formData) => {
        setIsloading(true);
        try {
            const response = await resetAdminPasscode(formData);
                            ...
                            <div className="auth-form">
                                ...
                                <form action={handleForm} className="global_form reverse-childs">
                                    <div className="form-group">
                                        <label><i className="fa fa-lock"></i> Old Admin Passcode</label>
                                        <input
                                            placeholder="Enter old admin passcode"
                                            name="oldAdminPasscode"
                                        />
                                    </div>
                                    <div className="form-group">
                                        <label><i className="fa fa-key"></i> New Admin Passcode</label>
                                        <input
                                            placeholder="Enter admin passcode"
                                            name="newAdminPasscode"
                                        />
                                    </div>
                                    <div className="form-group">
                                        <label><i className="fa fa-key"></i> Confirm Admin Passcode</label>
                                        <input
                                            placeholder="Confirm admin passcode"
                                            name="confirmAdminPasscode"
                                        />
                                    </div>
                                    <div className="form-group">
                                        <Submit />
